package com.foofu.service.system.user;
...
public class UserService {
	...
	*/
	public void deleteAllU(String[] userIds)throws Exception{
		dao.delete("UserXMapper.deleteAllU", userIds);
	}
	/*
	*用户列表(用户组)
	*/
	...
	*/
	...
	public PageData findByUNoCom(PageData pd) throws Exception {
		return (PageData)dao.findForObject("UserXMapper.findByUNoCom", pd);
	}
