  ...
  <body>
    <div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
  			<div class="row-fluid">
				<div class="row-fluid">
					<form action="trans/listExceptionTrans.do" method="post" name="transListForm" id="transListForm">
						...
						<table>
							...
							<tr>
								...
								<td style="vertical-align:top;"><button class="btn btn-mini btn-light" onclick="search();" title="检索"><i id="nav-search-icon" class="icon-search"></i></button>
	...
	<script type="text/javascript">
		...
		function toExcel(){
			...
			//导出
			window.location.href='<%=basePath%>trans/exceptionTrans.do?'
					+'depName='+depName
					+'&acqName='+acqName
					+'&mid='+mid
					+'&tid='+tid
